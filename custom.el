(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ztree zoutline zoom-window yafolding which-key use-package undo-tree swiper string-inflection solarized-theme smartparens sane-term rust-mode rich-minority posframe pos-tip pkgbuild-mode org-journal nlinum mwim magit keychain-environment iedit hydra helm-swoop helm-projectile helm-descbinds helm-ag golden-ratio flycheck-irony fill-column-indicator elisp-format dtrt-indent company-irony clang-format buffer-move ace-window)))
