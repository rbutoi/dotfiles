...
(defun setup-c/c++-company-backends ()
  (setq-local company-backends '(company-irony-c-headers company-irony)))
...
(define-key c-mode-base-map (kbd "C-o") 'rtags-imenu)
(define-key c-mode-base-map (kbd "C-c r f") 'rtags-next-match)
(define-key c-mode-base-map (kbd "C-c r b") 'rtags-previous-match)
#+END_SRC
