...
(use-package solarized-theme
  ...
  (let ((cmd-out (shell-command-to-string "xfconf-query --channel xsettings --property /Net/ThemeName --type string")))
    (unless (string= cmd-out "gtk2-theme-solarizedlight\n")
      (toggle-theme)))
...
(defun m-buffer-binds (m)
  (bind-keys :map m
             ...
             ("M-0" . (lambda () (interactive) (delete-window) (balance-windows)))
             ("M-1" . (lambda () (interactive) (delete-other-windows) (balance-windows)))
             ("M-2" . (lambda () (interactive) (split-window-below) (balance-windows)))
             ("M-3" . (lambda () (interactive) (split-window-right) (balance-windows)))
             ("M-=" . balance-windows)))
