...
(load "fira-code.el")
(defun fira-code-mode-all-prog-buffers (arg)
  (dolist (buffer (buffer-list))
    (with-current-buffer buffer
      (when (derived-mode-p 'prog-mode) (fira-code-mode arg)))))
...
(use-package solarized-theme
  ...
  (defun themed-if-window-system (frame)
    (if (window-system frame)
        (progn (themed-mode) (fira-code-mode-all-prog-buffers +1))
      (progn (unthemed-mode) (fira-code-mode-all-prog-buffers -1))))
